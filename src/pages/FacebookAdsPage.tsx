...
import { DollarSign, Eye, MousePointer, Target, TrendingUp, BarChart3, Percent, ExternalLink, Users, Filter, GraduationCap, Briefcase, BookOpen, FileText } from 'lucide-react'
...
function FunnelTab() {
  const { data: dealsRes } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await supabase.from('deals_full').select('canal_origem, stage_name, stage_order, is_won, qualification_status, created_at, motivo_perda')
      return data || []
    },
  })
